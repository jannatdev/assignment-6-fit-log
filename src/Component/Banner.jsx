...
const Banner = () => {
    return (
        <div className='grid gap-6 justify-center items-center ml-12  md:grid-cols-12  container mx-auto p-10'>
            <div className='text-center md:text-left md:col-span-8 ' >
                <div className=' w-Full md:w-[80%]  space-y-1.5'>
                    ...
                    <p className='italic  text-[#9CA3AF]'>FitLog is a dark, no-nonsense gym companion: pick a lift, lock it into {"today's"} plan, <br /> and watch the {"week's"} work add up.</p>
                </div>
                <Link href="#library">
            ...
            <Image src={BannerImg} alt="Banner Img" width={800} height={1000} className='col-span-4 mr-10 mt=10'/>
